    ...
    <View style={{flex: 1}}>
      ...
      <BoardImage source={require('../../../source/img/OneMinuteStudy/bg.png')}>
        ...
        <OptionBtn underlayColor={'#FFC853'} onPress={() => {}}>
          <OptionTx>选项选项选项选项选项</OptionTx>
        </OptionBtn>
        <OptionBtn
          style={{marginTop: 30}}
          underlayColor={'#FFC853'}
          onPress={() => {}}>
          <OptionTx>answer1</OptionTx>
        </OptionBtn>
        <OptionBtn
          style={{marginTop: 30}}
          underlayColor={'#FFC853'}
  ...
  switch (a) {
    ...
    case 3:
      return {
        a: 2,
        b: '53%',
        c: '新人级宝宝一枚，多学多看多问，装修难不倒你！',
      };
    case 4:
      return {
        a: 3,
        b: '77%',
        c: '进阶型潜力股，大坑可躲，小坑难防，学习让你变更强！',
      };
    case 5:
      return {
        a: 4,
        b: '91%',
        c: '装修知识很丰富嘛，据说好学努力的能力者会更迷人！',
      };
  }
};
const showstar = a => {
  switch (a) {
    case 1:
      return (
        <View style={{flexDirection: 'row'}}>
          <Star
            source={require('../../../source/img/OneMinuteStudy/star.png')}
          />
        </View>
      );
    case 2:
  ...
  return (
    <TopImage1 source={require('../../../source/img/OneMinuteStudy/top1.png')}>
      ...
      <TouchableOpacity
        ...
        onPress={() => {}}>
        <Image
          source={require('../../../source/img/OneMinuteStudy/study.png')}
        />
      </TouchableOpacity>
    </TopImage1>
  );
